...
const URL = 'https://apex-chat.jpadilla.com';
const SHARE_IMAGE_URL = `${URL}/static/share.png`;
const SOURCES = {
  original: {
    title: 'El chat de APEX',
    description: 'Las 72 páginas del chat de APEX',
    url: URL,
  },
};
    ...
    <>
      ...
      >
        ...
        <h3 className="text-sm text-gray-600">
          ...
          <a
            className="underline"
            href="https://twitter.com/jayfonsecapr/status/1262888196456751109/photo/1"
          >
            Jay Fonseca
          </a>
          .
        ...
        <h4 className="text-xs text-gray-500">
          ...
          . Código abierto en{' '}
          <a className="underline" href="https://github.com/jpadilla/apex-chat">
            GitHub
          </a>
        </h4>
